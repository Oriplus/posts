...
<label class="uppercase text-gray-700 text-sx">Slug</label>
<span class="text-xs text-red-600">
    @error('slug')
        {{ $message }}
    @enderror
...
<textarea name="body" id="body" cols="30" rows="5" class="rounded border-gray-200 w-full mb-4">{{ old('body', $post->body) }}</textarea>
